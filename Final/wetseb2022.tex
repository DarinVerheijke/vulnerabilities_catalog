...
We also found an increased percentage of call contracts using more guards.  
...
\todo[inline]{Please add a column to Table~\ref{tab:major-versions} about reentrancies.  I want to know how many contracts in the major versions have at least one reentrancy. }
...
A total of 1,990 contracts were flagged with atleast 1 reentrancy vulnerability out of the 13,443 contracts that contained a call function, this comes down to about 8.8\%. \todo[inline]{Please double check. 1990 / 13K = 14\%, the version before it was 1190 which would be 8.8\%. }
...
%Henrique: Almost put Future Work on a separate paragraph
