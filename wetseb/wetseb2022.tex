...
\copyrightyear{2022}
\acmYear{2022}
\setcopyright{acmlicensed}\acmConference[WETSEB'22 ]{5th Workshop on Emerging Trends in Software Engineering for Blockchain}{May 16, 2022}{Pittsburgh, PA, USA}
\acmBooktitle{5th Workshop on Emerging Trends in Software Engineering for Blockchain (WETSEB'22 ), May 16, 2022, Pittsburgh, PA, USA}
\acmPrice{15.00}
\acmDOI{10.1145/3528226.3528372}
\acmISBN{978-1-4503-9331-7/22/05}
...
%\renewcommand{\shortauthors}{Verheijke et al.}
...
Moreover, 97\% of all contracts are using the require guard, with 23 uses of require on average per contract. This may be an indication that Solidity developers are using more guards to prevent exploits in their contracts 
\end{abstract}

\keywords{Ethereum, Smart Contracts, Solidity,  Call,  Guards.}
...
%In this section we present basic concepts on Solidity language constructs and reentrancy attacks.
...
\henrique{I added a footnote which should suffice.  Otherwise we will need to change to SLoc in the ENTIRE paper and not just this table.  That is too much effort for a minor thing.}
...
\small
  ...
  \begin{tabular}{crrrr}
    ...
    Revert & 11,976 (89\%) & 38,273 & 2.84 & 2\\ \hline
\end{tabular}
\end{table}
